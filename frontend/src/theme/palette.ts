...
export interface ThemePalette {
  ...
  accent: PaletteColor;
  success: Omit<PaletteColor, 'lighter' | 'contrastText'>;
  error: Omit<PaletteColor, 'lighter' | 'contrastText'>;
  warning: Omit<PaletteColor, 'lighter' | 'contrastText'>;
  info: Omit<PaletteColor, 'lighter' | 'contrastText'>;
  background: {
    default: string;
    paper: string;
    dark: string;
...
const palette: Record<'light' | 'dark', ThemePalette> = {
  light: {
    primary: {
