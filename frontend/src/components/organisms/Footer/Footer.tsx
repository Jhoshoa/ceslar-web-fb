...
const Footer = () => {
  ...
  const resourceLinks: FooterLink[] = [
    ...
    { label: t('footer.terms', 'Terminos'), path: '/terms' },
  ];
        ...
        <Grid container spacing={4}>
          ...
          <Grid item xs={12} md={4}>
            ...
            >
              {t(
                'footer.description',
                'Cristo Es La Respuesta - Una red de iglesias unidas por la fe, comprometidas con llevar el evangelio y el amor de Cristo a toda Sudamerica.'
              )}
            </Typography>
            {/* Social Icons */}
