...
import { Container, Grid, Box, FormControl, InputLabel, Select, MenuItem, SelectChangeEvent } from '@mui/material';
...
const LEVELS = ['all', 'headquarters', 'country', 'department', 'province', 'local'] as const;
